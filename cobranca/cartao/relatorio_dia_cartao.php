...
$tipo_rel = "RelatorioDiaEMP".$csGarantia;
$modulo = "EMP";
...
$selec2 = mysql_query ("SELECT posicaocontabil.cc, analise_ger.sldaplicliq, posicaocontabil.dataemaberto, posicaocontabil.contrato, posicaocontabil.modalidade, posicaocontabil.nome, posicaocontabil.cpf_cnpj, posicaocontabil.diasematraso, posicaocontabil.sld_dev_ctbil, garantias_devedorSolidario.garantia  FROM posicaocontabil, garantias_devedorSolidario, analise_ger WHERE contrato NOT IN(SELECT cont FROM rel_carta_cob_emp WHERE $tc != '') AND (sld_em_atraso BETWEEN $vlr1 AND $vlr2) AND (diasematraso BETWEEN $tipocarta AND $tipocarta2) AND posicaocontabil.contrato = garantias_devedorSolidario.nro_titulo AND (posicaocontabil.cc = analise_ger.cc) ORDER BY posicaocontabil.diasematraso, nro_titulo");
}
...
$pdf->Cell(0, 0,'UNICRED RECIFE 2203', 0, 1, 'L');
...
$pdf->SetX("28");
$pdf->Cell(0, 0,'Dv Solidario', 0, 1, 'L');
