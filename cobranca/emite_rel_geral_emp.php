...
<link rel="stylesheet"
	...
	<script
		src="../jquery/development-bundle/ui/i18n/jquery.ui.datepicker-pt-BR.js"></script>
	<link rel="stylesheet"
		href="../jquery/development-bundle/demos/demos.css">
		<style>
h1 {
	padding: 0.2em;
	margin: 0;
...
<body>
	...
	<div id="products">
		<h1 class="ui-widget-header style9">Gerar Relatórios EMP</h1>
		<div id="catalog">
			<h3>
				<a href="#" class="style6">Relatório de Atraso</a>
			</h3>
			<div>
				<th width="982" scope="col"><div align="center"
						class="style1 style8" id="demo-config">Deseja emitir Relatório de
						Parcelas?</div></th>
				<ul class="style7">
					<form id="form1" name="form1" method="post"
						action="relatorio_parcelas.php">
						<label for="EMITIR"></label>

						<div align="center">
							<label for="dia1">Quantidade de dias</label> <input type="text"
								name="dia1" id="dia1" size="4"
								onkeypress="return numeros(event.keyCode, event.which);"
								maxlength="4" /> até <label for="dia2"></label><input
								type="text" name="dia2" id="dia2" size="4"
								onkeypress="return numeros(event.keyCode, event.which);"
								maxlength="4" />
							...
							<p>
								Gerente: <select id="gerente2207" name="gerente2207">
									...
									<option value="392">KARLA REGINA DA SILVA PEREIRA</option>
									<option value="371">MICHELLE GONÇALVES DOS SANTOS NEVES</option>
									...
									<option value="391">RILKA MARIA GONÇALVES DE OLIVEIRA</option>
									...
									<option value="126">ROSEMBERG SOUZA DE ARAUJO</option>
							...
							<p>
								<input type="submit" name="EMITIR" id="EMITIR" value="EMITIR"
									size="15" />
							</p>
						</div>
					</form>
			...
			<h3>
				<a href="#" class="style6">Relatório de Incluidos</a>
			</h3>
			<div>
				<th width="982" scope="col"><div align="center"
						class="style1 style8" id="demo-config">Deseja emitir Relatório de
				...
				<ul class="style7">
					<form id="form1" name="form1" method="post"
						action="relatorio_geral_emp.php">
						<label for="EMITIR"></label>
			...
			<h3>
				<a href="#" class="style6">Relatório para Inclusão</a>
			</h3>
			<div>
				<th width="982" scope="col"><div align="center"
						class="style1 style8">Deseja emitir Relatório para Inclusão?</div>
				</th>
				<ul class="style7">
					<form id="form1" name="form1" method="post" target="mainFrame"
						action="relatorio_dia_emp.php">
						<label for="diaad"></label> <label for="enviar"></label>
						<div align="center">
							<span class="style2">Tipo de carta:</span> <select name="diaemp"
								id="diaemp">
							...
							<!-- <p>
								<label> <input name="csGarantia" type="radio" id="csGarantia_0"
									value="cGarantia" checked="checked" /> COM GARANTIA</label> <br />
								<label> <input type="radio" name="csGarantia" value="sGarantia"
									id="csGarantia_1" /> SEM GARANTIA</label> <br />
							</p> -->
			...
			<h3>
				<a href="#" class="style6">Relatório Exclusão</a>
			</h3>
			<div>
				<th width="982" scope="col"><div align="center"
						class="style1 style8">Deseja emitir Relatório Exclusão?</div></th>
				<form id="form1" name="form1" method="post"
					action="rel_exclusao_emp.php">
					<label for="EMITIR"></label>
			...
			<h3>
				<a href="#" class="style6">Relatório de Atualização</a>
			</h3>
			<div>
				<th width="982" scope="col"><div align="center"
						class="style1 style8">Deseja emitir Relatório Atualização?</div></th>
				<form id="form1" name="form1" method="post"
					action="rel_atualiza_emp.php">
					<label for="EMITIR"></label>
