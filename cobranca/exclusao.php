...
$deleta = mysql_query("DELETE FROM rel_carta_cob_ad WHERE CC = '$CC'"); 
...
$inseri_registro = mysql_query("INSERT INTO registros_cobranca (data_registro, hora, usuario, tipo_alt, modulo, tipo_carta, data_carta, CC_Contrato, nome, DiasEmAtraso, DataAtraso, Vlr_Atraso) VALUES ('$data_registro', '$hora_registro', '$usuario', 'EXCLUSAO', 'AD', '' , '', '$CC', '$nome', '$dias_ad', '$data_ad', '$adto')");
...
<table width="1000" border="0">
  <tr>
    <th width="990" scope="col"><span class="style3"><?php echo "EXCLUSÃO REALIZADA COM SUCESSO!!!" ?> </span>      <p class="style1"><span class="style3">Para voltar</span> <a href="consul_exclusao.php" class="style3">Clique aqui!</a></p></th>
  </tr>
</table> 
