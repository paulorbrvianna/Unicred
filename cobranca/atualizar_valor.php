...
echo $conta = $_SESSION['conta'];
echo $nome = $_SESSION['nome'];
echo $adto = $_SESSION['adto'];
echo $dias_ad = $_SESSION['dias_ad'];

echo $data_ad = $_SESSION['data_ad'];

$insert = mysql_query("UPDATE rel_carta_cob_ad SET Adto1 = '$adto' WHERE CC = '$conta'");
...
<meta charset="utf-8">
	...
	<div class="ui-widget-content">
		  <p align="center" ><span class="style28">Para atualizar um novo valor</span> <span class="style28"><a href="consul_atualiza.php" target="mainFrame">Click aqui!</a></span></p>
  	  </div>
</div>
