...
<div id="products">
	<h1 class="ui-widget-header style9">Relatórios AD</h1>	
<div id="catalog">
		<h3> <a href="#" class="style6">Relatório de Adiantamentos</a> </h3>
		<div>
        <th width="982" scope="col"><div align="center" class="style1 style8" id="demo-config"> Deseja emitir Relatório de Adiantamentos?</div></th>
		  <ul class="style7">
			<form id="form1" name="form1" method="post" action="relatorio_adiantamentos.php">
        ...
        <th width="982" scope="col"><div align="center" class="style1 style8" id="demo-config"> Deseja emitir Relatório de Incluidos?</div></th>
		  <ul class="style7">
			<form id="form1" name="form1" method="post" action="relatorio_geral.php">
            <label for="EMITIR"></label>
        ...
        <th width="982" scope="col"><div align="center" class="style1 style8"> Deseja emitir Relatório para Inclusão?</div></th>
		  <ul class="style7">
		  <form id="form1" name="form1" method="post" target="mainFrame" action="relatorio_dia_ad.php">
