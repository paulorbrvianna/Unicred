...
<meta charset="utf-8">
    ...
    <div id="titi">
	<h1 class="ui-widget-header">Incluir Contrato</h1>
	<div class="ui-widget-content">
	  <p align="center" class="style1 style2 style4 style5"><form action="incluir_emp.php" method="post" name="form1" target="mainFrame" id="form1">
      <strong>
  <label for="incluir_conta"></label>
  <span class="style5">Digitar Nº do Contrato: </span>
