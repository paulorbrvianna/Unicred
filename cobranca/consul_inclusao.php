...
<meta charset="utf-8">
    ...
    <div id="titi">
	<h1 class="ui-widget-header">Incluir Conta</h1>
	<div class="ui-widget-content">
	  <p align="center" class="style1 style2 style4 style5"><form id="form1" action="incluir.php" method="post" name="form1" target="mainFrame" >
      <strong>
  <label for="incluir_conta"></label>
  <span class="style5">Digitar Conta: </span>
  ...
  <input type="submit" name="incluir" id="incluir" value="Pesquisar" onclick="difvazio(); return false;" onfocus="proximoCampo ='fin'"/>
      </strong>
    </form></p>
	  </div>
</div>
