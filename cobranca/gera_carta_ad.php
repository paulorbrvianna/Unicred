...
<body onload="MM_openBrWindow('cobcarta_ad.pdf','','')" >
...
if ($resul2['limite_chesp']>0){
$pdf-> Cell(26,0.6, iconv('utf-8','iso-8859-1',' '.' '.' '.' '.' '.' '.' '.' '. ' '.'Vimos, pela presente, comunicar-lhe que Vossa Senhoria vem utilizando o cheque espe- '),0,1,'J'); 
$pdf-> Cell(19,0.6, iconv('utf-8','iso-8859-1','cial acima do limite do crédito desde '.$resul2['data_ad']),0,1,'J');
...
$pdf-> Cell(26,0.6, iconv('utf-8','iso-8859-1',' '.' '.' '.' '.' '.' '.' '.' '. ' '.'Vimos, pela presente, comunicar-lhe que Vossa Senhoria encontra-se em AD '),0,1,'J'); 
$pdf-> Cell(19,0.6, iconv('utf-8','iso-8859-1','(Adiantamento a Depositante) desde '.$resul2['data_ad']),0,1,'J');
}
$pdf->Ln();
