...
<meta charset="utf-8">
    ...
    <div id="titi">
	<h1 class="ui-widget-header">Consultar Relatórios</h1>
	<div class="ui-widget-content">
	  <p align="center" class="style1 style2 style4 style5"><form action="resul_relatorios.php" method="post" name="form1" target="mainFrame" class="style4" id="form1">
  <label for="incluir_conta"></label>
  <span class="style6">Data do Relatório:</span> 
  <input type="text" name="relatorios" id="datepicker" size="20" maxlength="15" value="<?php echo date("d/m/Y") ?>" />
