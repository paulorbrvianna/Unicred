...
#enviar{ margin:0 0 0 350px; width:190px; height:60px; color:#333333; background:url(bntEnviar.png); border:none  }
#enviar:hover{ margin:0 0 0 350px;;width:190px; height:68px; color:#333333; background:url(bntEnviar.png) bottom no-repeat; border:none  }
</style>
...
?>
<table style="margin:-25px 0 0 300px; background:url(topS.png); height:90px" width="450" border="0">
  <tr>
...
<form action="AutorizacaoSMS.php" method="post">
<input name="qtd" type="hidden" value="<?php echo $num_linhas2; ?>" />

<table width="300" border="0" style=" margin:0 0 0 580px">
  <tr>
    <td width="130"><a href="#" id="MTodas">Marcar todas</a></td>
...
?>
<input name="Autorizar" id="enviar"  type="submit" value=" " />
