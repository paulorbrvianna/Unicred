...
<div id="products">
	<h1 class="ui-widget-header">Emissão de Cartas e Envelopes</h1>	
<div id="catalog">
	...
	$(function() {
		$( "#datepicker" ).datepicker({
			...
			altFormat: "dd 'de' MM 'de' yy"
            	...
            	<form id="form1" name="form1" method="post" target="mainFrame" action="carta_emp.php">
        <h1>
          <label for="diaemp"></label>
		...
		<h3><a href="#">Emissão de Envelopes EMP</a></h3>
		<div>
			<ul>
				       	<form id="form1" name="form1" method="post" target="mainFrame" action="envelope_carta_emp.php">
        <h1>
          <label for="diaemp"></label>
                <label for="enviar"></label>
        </h1>
        <div align="right">
          <h1 align="center">&nbsp;</h1>
          <h1 align="center"><span class="style5">Tipo de carta:</span>      
            <select name="diaempenv" id="diaempenv" >
              <option value="C1">C1</option>
