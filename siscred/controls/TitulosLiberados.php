...
require_once 'C:\xampp\htdocs\siscred\lumine/Lumine.php';
require_once 'C:/xampp/htdocs/siscred/lumine-conf.php';

Lumine::load('Form_White');

$cfg = new Lumine_Configuration( $lumineConfig );
$cfg->import('TitulosLiberados');
register_shutdown_function(array($cfg->getConnection(), 'close'));

$obj = new TitulosLiberados;
